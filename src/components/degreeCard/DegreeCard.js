...
function DegreeCard(props) {
  ...
  const style_img = style({
    ...
    marginRight: "50px",
    boxShadow: `0px 0px 5px ${theme.black}`,
  ...
  const card_body = style({
    ...
    width: "90%",
    margin: "10px",
    boxShadow: `0px 1px 5px ${theme.black}`,
    transition: "all 0.2s ease-in-out",
    ":hover": {
      color: "rgba(255, 255, 255, 1)",
      boxShadow: `0 5px 15px ${theme.black}`,
  ...
  const button_visit = style({
    ...
    ":hover": {
      color: "rgba(255, 255, 255, 1)",
      boxShadow: `0 5px 10px ${theme.black}`,
    },
  });
        ...
        <div {...card_body}>
          ...
          >
            <div className="body-header-title">
              ...
              <h3 className="card-subtitle" style={{ color: "#000000" }}>
                {degree.subtitle}
              </h3>
            </div>
            <div className="body-header-duration">
              <h3 className="duration" style={{ color: "#000000" }}>
                {degree.duration}
              </h3>
            </div>
          </div>
